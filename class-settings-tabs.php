...
//        $this->textdomain = isset($args['textdomain']) ? $args['textdomain'] : '';
    ...
    public function field_text( $option ){
        ...
        ob_start();
        ?>
        <input type="text" <?php if($readonly): ?>readonly="readonly"<?php endif; ?> class="" name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>" placeholder="<?php echo $placeholder; ?>" value="<?php echo esc_attr($value); ?>" />
        <?php
